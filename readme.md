...
一个**前后端分离**的 AR 粒子特效代码平台：浏览、预览、导出 **15 款粒子特效**（3 款 WebAR + 12 款高级 3D 粒子），并提供完整的**用户体系、收藏、订单、会员订阅、管理员后台**能力。
...
| 模块 | 能力 |
| --- | --- |
| 特效 | 15 款特效：3 款 WebAR（星系/海水/人像粒子）+ 12 款高级 3D 粒子（雪花/雨/花瓣/樱花/蝴蝶/游鱼/飞鸟/萤火虫/点阵/粒子波/烟花/星云） |
